    ...
    const checkConnection = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                Alert.alert(
                    'Não conectado',
                    'Parece que você ainda não está conectado à rede do alimentador. Verifique sua conexão WiFi.'
                );
            }
        } catch {
            Alert.alert(
                'Não conectado',
                `Conecte-se à rede "${NETWORK_NAME}" nas configurações de WiFi do seu dispositivo.`
            );
        } finally {
            setChecking(false);
        }
